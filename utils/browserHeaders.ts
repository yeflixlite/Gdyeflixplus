 ...
 * @param referer  – URL de origen (Referer)
 * @param origin   – Origen (Origin)
 */
function getBrowserHeaders(referer = '', origin = ''): Record<string, string> {
 ...
 */
function getMediaHeaders(referer = '', origin = ''): Record<string, string> {
