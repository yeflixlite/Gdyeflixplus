...
async function extract(url) {
    ...
    if (!id)
        throw new Error('ID de Dailymotion no encontrado.');
    ...
    if (!qualities)
        throw new Error('Dailymotion no devolvió calidades de video.');
